...
/**
 * Servlet filter which uses a {@link SecurityTokenGenerator} to add a header
 * field to the {@link HttpServletResponse}.
 * <p>
 * The name of the header is the parameter in
